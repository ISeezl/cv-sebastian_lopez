...
const content = {
  es: {
    ...
    skills: [
      ...
      { label: 'AWS / Cloud', items: ['Conceptos básicos AWS', 'Experiencia práctica limitada', 'Despliegue cloud', 'GitHub Actions', 'CI/CD'] },
  ...
  en: {
    ...
    skills: [
      ...
      { label: 'AWS / Cloud', items: ['Basic AWS concepts', 'Limited hands-on experience', 'Cloud deployment', 'GitHub Actions', 'CI/CD'] },
